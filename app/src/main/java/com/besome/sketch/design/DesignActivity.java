...
public class DesignActivity extends BaseAppCompatActivity implements View.OnClickListener {
    ...
    private CodeEditorTabFragment eventTabAdapter;
    private AIChatTabFragment componentTabAdapter;
    ...
    public void onBackPressed() {
        if (viewTabAdapter.isPropertyViewVisible()) {
    ...
    private class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public Object instantiateItem(@NonNull ViewGroup container, int position) {
            ...
            if (position == 0) {
                ...
                eventTabAdapter = (CodeEditorTabFragment) fragment;
            } else {
                componentTabAdapter = (AIChatTabFragment) fragment;
            }
        ...
        public Fragment getItem(int position) {
            if (position == 0) {
                ...
                return position == 1 ? new CodeEditorTabFragment() : new AIChatTabFragment();
            }
        }
    }
}
